...
const products = [
  ...
  },
  {
    ...
    descriptionAr: "تسع درجات متناغمة من الوردي الحالم، الروز جولد البرّاق، والنود المخملي لابتكار إطلالات ساحرة نهارية ومسائية.",
    price: 215,
    compareAtPrice: 250,
  ...
  },
  {
    ...
    descriptionAr: "كريم ترطيب فائق الغنى بالكولاجين النباتي وخلاصة زهرة الكاميليا والورد لترميم حاجز البشرة وترطيبها بعمق.",
    price: 180,
    compareAtPrice: 210,
    category: "العناية الفائقة بالبشرة",
